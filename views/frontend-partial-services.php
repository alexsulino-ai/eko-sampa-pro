        ...
        <div class="space-y-4">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm" x-show="state.form.id">
                ...
                <div class="mt-3 rounded-lg border border-slate-100 bg-slate-50/80 p-3">
                    ...
                    <p class="mt-2 text-[11px] font-medium text-amber-800" x-show="state.fieldForm._validationLegacyRaw" x-cloak>
                        <?php echo esc_html__('Legacy validation is stored on the server. It is kept on save unless you set rules below — then the new rules replace it.', 'eko-sampa'); ?>
                    </p>
