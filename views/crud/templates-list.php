                ...
                <template x-for="r in state.rows" :key="r.id">
                    <tr class="hover:bg-slate-50/80">
                        ...
                        <td class="px-4 py-3 text-right whitespace-nowrap">
                            ...
                            <a class="ml-3 text-slate-600 hover:underline" :href="editorUrl(r.id)"><?php echo esc_html__('Editor', 'eko-sampa'); ?></a>
                            <button type="button" class="ml-3 text-slate-600 hover:underline" @click="duplicate(r.id)"><?php echo esc_html__('Duplicate', 'eko-sampa'); ?></button>
