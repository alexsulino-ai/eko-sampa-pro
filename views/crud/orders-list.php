...
$new_url = Eko_Sampa_Frontend_Router::get_resource_url('orders', 'new');
...
<div class="mx-auto max-w-6xl space-y-6" x-data="window.ekoOrdersFactory()" x-init="init()">
    <div class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <a class="rounded-lg bg-indigo-600 px-3 py-2 text-sm font-medium text-white hover:bg-indigo-700" href="<?php echo esc_url($new_url); ?>"><?php echo esc_html__('New order', 'eko-sampa'); ?></a>
        </div>
    </div>
